...
import { asyncLoderTv, removieTv } from "../../store/actions/TvAction";
import SeasonsCard from "../../templats/SeasonsCard";
...
const TvDeatils = () => {
  ...
  useEffect(() => {
    dispatch(asyncLoderTv(id));
    return () => {
      dispatch(removieTv(id));
    };
  }, [id]);
  ...
  return info ? (
    ...
    <div className="w-full h-[100vh] text-[5rem] bg-[black] text-[red] flex items-center justify-center  ">
      Loding...
    </div>
  );
};

export default TvDeatils;
